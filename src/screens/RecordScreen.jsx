...
import { getSuggestions, analyzePhoto, proofreadText, getStoredKey } from '../utils/gemini';
    ...
    <div className="tab-content px-4 pt-4 pb-24 space-y-4">
      ...
      <div className="flex rounded-2xl overflow-hidden"
        ...
        {[
          ...
          <button key={m.id} onClick={() => { setMode(m.id); setSuggestions([]); setSelected([]); setProofread(null); }}
